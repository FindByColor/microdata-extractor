 ...
 */
const expected = JSON.parse(fileReader('test/resources/commerce-cloud-under-armour.json'))
const html = fileReader('test/resources/commerce-cloud-under-armour.html')
...
describe('Microdata Extractor - Commerce Cloud - Under Armour', function () {
