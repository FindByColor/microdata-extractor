 ...
 */
const expected = JSON.parse(fileReader('test/resources/commerce-cloud-coach.json'))
const html = fileReader('test/resources/commerce-cloud-coach.html')
...
describe('Microdata Extractor - Commerce Cloud - Coach', function () {
